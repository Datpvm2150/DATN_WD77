                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.sanphams.index') }}" method="GET"
                        ...
                        <div style="flex: 1; min-width: 200px">
                            <label for="danh_muc_id" style="display: block; font-weight: bold; margin-bottom: 5px;">Danh
                                mục:</label>
                            <select name="danh_muc_id" id="danh_muc_id"
                                ...
                                @foreach ($danhMucs as $danhMuc)
                                    <option value="{{ $danhMuc->id }}"
                                        {{ request('danh_muc_id') == $danhMuc->id ? 'selected' : '' }}>
                        ...
                        <!-- Lọc theo ngày tạo -->
                        <div style="flex: 1; min-width: 200px;">
                            <label for="ngay_tao" style="display: block; font-weight: bold; margin-bottom: 5px;">Ngày
                                tạo:</label>
                        ...
                        <div style="flex: 1; min-width: 200px;">
                            ...
                            <select name="trang_thai" id="trang_thai"
                                ...
                                <option value="0" {{ request('trang_thai') == '0' ? 'selected' : '' }}>Ngừng hoạt động
                                </option>
                            </select>
                        </div>
                        <!-- Nút lọc -->
