                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            @if ($hoaDon->phuong_thuc_thanh_toan === 'Thanh toán qua chuyển khoản ngân hàng')
                                                                <form action="{{ route('admin.hoadons.query') }}"
                                                                    method="POST" style="display: inline;">
                                                                    @csrf
                                                                    <input type="hidden" name="txnRef"
                                                                        value="{{ $hoaDon->ma_hoa_don }}">

                                                                    <!-- Sửa đây: Chuyển thời gian từ 'ngay_dat_hang' sang định dạng 'YmdHis' -->
                                                                    <input type="hidden" name="transactionDate"
                                                                        value="{{ \Carbon\Carbon::parse($hoaDon->thoi_gian_giao_dich)->format('YmdHis') }}">

                                                                    <button type="submit" class="btn btn-sm btn-info">Tra
                                                                        cứu</button>
                                                                </form>
                                                            @endif
                                                        </li>
                                                        <li>
                                                            ...
                                                            <b
                                                                ...
                                                                @elseif ($hoaDon->trang_thai_thanh_toan === 'Thanh toán thất bại') bg-secondary @endif">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p class="mb-0 fw-medium fs-15">
                                                                            <span
                                                                                class="text-danger">-{{ number_format($giamGia, 0, '', '.') }}
                                                                                đ</span>
                                                                        </p>
                                                                    </td>
                                                                </tr>
