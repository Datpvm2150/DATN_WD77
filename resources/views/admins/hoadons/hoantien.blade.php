<form action="{{ route('admin.hoadons.refund') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="TxnRef" name="TxnRef" placeholder="Nhập mã tham chiếu"
            required>
    </div>

    <div class="form-group">
        <label for="Amount">Số Tiền Hoàn (VND)</label>
        <input type="number" class="form-control" id="Amount" name="Amount" placeholder="Nhập số tiền hoàn"
            required>
    </div>

    <div class="form-group">
        <label for="TransactionDate">Ngày Giao Dịch (YmdHis)</label>
        <input type="text" class="form-control" id="TransactionDate" name="TransactionDate" placeholder="20241128"
            required>
    </div>

    <div class="form-group">
        <label for="CreateBy">Người Khởi Tạo</label>
        <input type="text" class="form-control" id="CreateBy" name="CreateBy" placeholder="Nhập tên người khởi tạo"
            required>
    </div>
