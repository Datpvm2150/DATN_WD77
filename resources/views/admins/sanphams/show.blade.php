...
@section('content')
    ...
    <style>
        #view_dgia {
            min-height: 500px;
            /* Chỉnh lại độ cao tối thiểu theo nhu cầu */
        ...
        .rating-filter .filter-btn {
            display: inline-flex;
            /* Dùng inline-flex để nút không chiếm toàn bộ dòng */
            align-items: center;
        ...
        .rating-filter .filter-btn.active {
            border-color: #0056b3;
            /* Viền màu khác khi nút được chọn */
        }

        .star {
            margin-left: 5px;
            /* Khoảng cách giữa số và ngôi sao */
            font-size: 1.2rem;
            /* Kích thước ngôi sao */
            color: orange;
        ...
        .star {
            ...
            /* Kích thước ngôi sao */
            line-height: 1.5;
            /* Căn chỉnh sao với thanh tiến độ */
        }

        span {
            line-height: 1.5rem;
            /* Đảm bảo phần trăm căn giữa với thanh tiến độ */
        }
                        ...
                        @foreach ($starPercentage as $star => $percentage)
                            <li class="d-flex align-items-center mb-2">
                                ...
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar bg-warning" style="width: {{ number_format($percentage) }}%;">
                                    </div>
                                </div>
