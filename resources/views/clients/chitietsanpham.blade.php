                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(response) {
                                                        if (response.status === 'success') {
                                                            document.getElementById('new-price').innerText = response.gia_moi.toLocaleString() +
                                                                'đ';
                                                            document.getElementById('old-price').innerText = response.gia_cu.toLocaleString() +
                                                                'đ';
                                                        } else {
                                                            document.getElementById('new-price').innerText = 'Không có giá';
                                                            document.getElementById('old-price').innerText = '';
                                                        }
                                                    }
                                                });
                                            } else {
                                                document.getElementById('new-price').innerText = '';
                                                document.getElementById('old-price').innerText = '';
                                            }
                                        }
                                    </script>
                    ...
                    <!-- product details area end -->
                                                                                        ...
                                                                                        <section
                                                                                            ...
                                                                                            <div class="container">
                                                                                                <div class="row">
                                                                                                    <div
                                                                                                        class="tp-section-title-wrapper-6 text-center mb-40">
                                                                                                        <h3
                                                                                                            class="tp-section-title-6">
                                                                                                            Sản phẩm liên
                                                                                                            quan</h3>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="row">
                                                                                                    <div
                                                                                                        class="tp-product-related-slider">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                @foreach ($sanPhamMoiNhat as $sanPham)
                                                                                                                    <div
                                                                                                                        class="swiper-slide">
                                                                                                                        <div
                                                                                                                            class="tp-product-item-3 tp-product-style-primary mb-50">
                                                                                                                            <div
                                                                                                                                class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                                                                                                <a
                                                                                                                                    href="{{ route('chitietsanpham', ['id' => $sanPham->id]) }}">
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                class="tp-product-content-3">
                                                                                                                                <div
                                                                                                                                    class="tp-product-tag-3">
                                                                                                                                    <span>{{ $sanPham->danhMuc ? $sanPham->danhMuc->ten_danh_muc : '' }}</span>
                                                                                                                                </div>
                                                                                                                                <h3
                                                                                                                                    class="tp-product-title-3">
                                                                                                                                    <a
                                                                                                                                        href="{{ route('chitietsanpham', ['id' => $sanPham->id]) }}">{{ $sanPham->ten_san_pham }}</a>
                                                                                                                                </h3>
                                                                                                                                <div
                                                                                                                                    class="tp-product-price-wrapper-3">
                                                                                                                                    <span
                                                                                                                                        class="tp-product-price-3">
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="tp-related-swiper-scrollbar tp-swiper-scrollbar">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            ...
                                                                                                            data-bs-target="#producQuickViewModal"><i
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <span
                                                                                                                    class="tp-product-details-price old-price">$320.00</span>
                                                                                                                <span
                                                                                                                    class="tp-product-details-price new-price">$236.00</span>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="tp-product-details-variation-list">
                                                                                                                        <button
                                                                                                                            type="button"
                                                                                                                            class="color tp-color-variation-btn">
                                                                                                                            <span
                                                                                                                                data-bg-color="#F8B655"></span>
                                                                                                                            <span
                                                                                                                                class="tp-color-variation-tootltip">Yellow</span>
                                                                                                                        </button>
                                                                                                                        <button
                                                                                                                            type="button"
                                                                                                                            class="color tp-color-variation-btn active">
                                                                                                                            <span
                                                                                                                                data-bg-color="#CBCBCB"></span>
                                                                                                                            <span
                                                                                                                                class="tp-color-variation-tootltip">Gray</span>
                                                                                                                        </button>
                                                                                                                        <button
                                                                                                                            type="button"
                                                                                                                            class="color tp-color-variation-btn">
                                                                                                                            <span
                                                                                                                                data-bg-color="#494E52"></span>
                                                                                                                            <span
                                                                                                                                class="tp-color-variation-tootltip">Black</span>
                                                                                                                        </button>
                                                                                                                        <button
                                                                                                                            type="button"
                                                                                                                            class="color tp-color-variation-btn">
                                                                                                                            <span
                                                                                                                                data-bg-color="#B4505A"></span>
                                                                                                                            <span
                                                                                                                                class="tp-color-variation-tootltip">Brown</span>
                                                                                                                        </button>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <h3
                                                                                                                    class="tp-product-details-action-title">
                                                                                                                    Quantity
                                                                                                                </h3>
                                                                                                                <div
                                                                                                                    class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                                                                                                                    <div
                                                                                                                        class="tp-product-details-quantity">
                                                                                                                        <div
                                                                                                                            class="tp-product-quantity mb-15 mr-15">
                                                                                                                            <span
                                                                                                                                class="tp-cart-minus">
                                                                                                                                <svg width="11"
                                                                                                                                    height="2"
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <button
                                                                                                                            class="tp-product-details-add-to-cart-btn w-100">Thêm
                                                                                                                            vào
                                                                                                                            giỏ
                                                                                                                            hàng</button>
                                                                                                                    </div>
                                                                                                                ...
                                                                                                                <button
                                                                                                                    class="tp-product-details-buy-now-btn w-100">Mua
                                                                                                                    ngay</button>
                                                                                                            </div>
                                                                                                            <div
