...
@if ($bienthesanphams->isNotEmpty())
    ...
    <span class="tp-product-details-price new-price" id="new-price">{{
        number_format($bienthesanphams->first()->gia_moi, 0, ',', '.') }}₫</span>
@else
    <span class="tp-product-details-price old-price" id="old-price">Đang cập nhật</span>
    <span class="tp-product-details-price new-price" id="new-price">Đang cập nhật</span>
@endif
