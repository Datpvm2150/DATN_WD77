        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.khuyen_mais.index') }}" method="GET"
                        ...
                        <div style="flex: 1; min-width: 170px;">
                            <label for="ngay_bat_dau" style="display: block; font-weight: bold; margin-bottom: 5px;">Ngày
                                bắt đầu:</label>
                        ...
                        <!-- Ngày kết thúc -->
                        <div style="flex: 1; min-width: 170px;">
                            <label for="ngay_ket_thuc" style="display: block; font-weight: bold; margin-bottom: 5px;">Ngày
                                kết thúc:</label>
                        ...
                        <div class="mt-3">
                            <button type="submit"
                                style="padding: 10px; border: none; border-radius: 4px; background-color: #4CAF50; color: white; font-weight: bold; cursor: pointer; width: 100%;">Lọc</button>
                        </div>
                    </form>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.khuyen_mais.show', $khuyenmai->id) }}">Xem</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.khuyen_mais.edit', $khuyenmai->id) }}">Sửa</a>
                                                        @if ($khuyenmai->trang_thai == 1)
                                                            <form
                                                                action="{{ route('admin.khuyen_mais.onOffKhuyenMai', $khuyenmai->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('post')
                                                        ...
                                                        <form
                                                            action="{{ route('admin.khuyen_mais.destroy', $khuyenmai->id) }}"
                                                            method="POST"
