                    ...
                    <div class="tp-checkout-verify">
                        <div class="tp-checkout-verify-item">
                            @guest
                                ...
                                <p class="tp-checkout-verify-reveal">Khách hàng quay lại? <button type="button"
                                        class="tp-checkout-login-form-reveal-btn">Nhấn vào đây để đăng nhập</button></p>
                            @endguest
                                ...
                                <div class="tp-checkout-bill-inner">
                                    <div class="row">
                                        ...
                                        <div class="tp-checkout-input">
                                            ...
                                            <div class="invalid-feedback">Vui lòng chọn địa chỉ hoặc nhập địa chỉ mới.
                                            </div>
                    ...
                    <div class="tp-checkout-place white-bg">
                            ...
                            <ul>
                                ...
                                <li class="tp-checkout-verify-item">
                                    <span id="discountApplySection" class="tp-checkout-verify-reveal">
                                        Có mã giảm giá? <button type="button" id="showCouponForm"
                                            class="tp-checkout-coupon-form-reveal-btn">Nhập mã</button>
                                    </span>
                        ...
                        <div class="tp-checkout-payment">
                            ...
                            <div class="tp-checkout-payment-item">
                                <input id="direct-bank-transfer" type="radio" name="payment"
                                    value="Thanh toán qua chuyển khoản ngân hàng" required>
                                <label for="direct-bank-transfer">Chuyển khoản ngân hàng</label>
                                <p>Thực hiện thanh toán của bạn trực tiếp vào tài khoản ngân hàng của chúng tôi. Vui lòng sử
                                    dụng ID đơn hàng của bạn như một mã tham chiếu thanh toán.</p>
                            </div>
                            ...
                            <div class="invalid-feedback" id="paymentError" style="display: none;">Vui lòng chọn phương
                                thức thanh toán.</div>
                        </div>
