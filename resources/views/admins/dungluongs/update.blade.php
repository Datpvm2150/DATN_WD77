        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="{{ route('admin.dungluongs.update',$dungluongs->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="ten_dung_luong" class="form-label">Tên Dung Lượng</label>
                                     <input type="text" class="form-control" id="ten_dung_luong" name="ten_dung_luong" value="{{ $dungluongs->ten_dung_luong}}">
