...
class SanPhamController extends Controller
{
    ...
    {
        $query = SanPham::with('bienTheSanPhams', 'hinhAnhSanPhams', 'tagSanPhams');
        // Lọc theo danh mục
    ...
    public function trash()
    {
        ...
        $sanphams = SanPham::onlyTrashed()->get();
        return view('admins.sanphams.trash', compact('sanphams', 'danhMucs'));
    }
