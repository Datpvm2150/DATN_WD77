...
@section('css')
    ...
    <link href="{{ asset('assets/admin/libs/datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/admin/libs/datatables.net-keytable-bs5/css/keyTable.bootstrap5.min.css') }}"
                    ...
                    <div class="card">
                        ...
                        <form action="" method="GET"
                            ...
                            <div style="flex: 1; min-width: 200px;">
                                <label for="trang_thai_phan_hoi"
                                    style="display: block; font-weight: bold; margin-bottom: 5px;">Trạng thái:</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        ...
                                                        <!-- Nếu không có người dùng, hiển thị thông báo khác -->
                                                    @endif
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.lienhes.form.reply', ['id' => $lienhe->id]) }}"
                                                        class="btn btn-success">Gửi phản hồi</a>
                                                </td>
